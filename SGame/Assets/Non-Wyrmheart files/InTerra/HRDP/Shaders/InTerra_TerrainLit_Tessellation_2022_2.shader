Shader "InTerra/HDRP Tessellation/Terrain (Lit with Features) 2022.2 or Heigher"
{
    Properties
    {
        ...
        [HideInInspector]_TessellationMaxDisplacement("The Layers Heighest Amplitude", Float) = 1
    ...
    SubShader
    {
        PackageRequirements { "com.unity.render-pipelines.high-definition":"[14.0.0,16.0.0]" }
    ...
    SubShader
    {
            ...
            Pass
        {
            ...
            #define SHADOW_LOW
            #include "InTerra_TerrainLitTemplateRayTracing.hlsl"
    ...
    Dependency "BaseMapShader" = "Hidden/InTerra/HDRP/TerrainLit_Basemap_2022_2"
