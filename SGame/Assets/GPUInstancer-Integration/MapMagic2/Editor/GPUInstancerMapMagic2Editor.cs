...
{
    [CustomEditor(typeof(GPUInstancerMapMagic2Integration))]
    [CanEditMultipleObjects]
    public class GPUInstancerMapMagic2Editor : GPUInstancerEditor
    {
        ...
        protected SerializedProperty prop_simulateDetailsAtEditor;
        protected SerializedProperty prop_useFloatingOriginHandler;
        protected SerializedProperty prop_floatingOriginTransform;

        private GPUInstancerMapMagic2Integration _mapMagicIntegration;
        ...
        protected override void OnEnable()
        {
            ...
            prop_simulateDetailsAtEditor = serializedObject.FindProperty("simulateDetailsAtEditor");
            ...
            _mapMagicIntegration = (target as GPUInstancerMapMagic2Integration);
            FillPrototypeList();
        }
...
#else
            EditorGUILayout.HelpBox("Map Magic 2 is not present!", MessageType.Error);
#endif
        ...
        public void DrawMapMagicDetailGlobalInfoBox()
        {
            ...
            float newMaxDetailDistance = EditorGUILayout.Slider(GPUInstancerEditorConstants.TEXT_maxDetailDistance, _mapMagicIntegration.terrainSettings.maxDetailDistance, 0, GPUInstancerConstants.gpuiSettings.MAX_DETAIL_DISTANCE);
            ...
            EditorGUILayout.PropertyField(prop_simulateDetailsAtEditor);
            DrawHelpText("If enabled, Terrain details will be rendered with the Detail Manager in editor mode.");
        ...
        [MenuItem("Tools/GPU Instancer/Integration/Add MapMagic 2 Integration", validate = false, priority = 952)]
        public static void ToolbarAddMapMagicIntegration()
        {
            GameObject go = new GameObject("GPUI MapMagic 2 Integration");
            go.AddComponent<GPUInstancerMapMagic2Integration>();

            Selection.activeGameObject = go;
            Undo.RegisterCreatedObjectUndo(go, "Add GPUI Map Magic 2 Integration");
        }

        [MenuItem("Tools/GPU Instancer/Integration/Add MapMagic 2 Integration", validate = true)]
        public static bool ValidateToolbarAddMapMagicIntegration()
        {
            return GameObject.FindObjectOfType<MapMagic.Core.MapMagicObject>() != null;
        }
#endif
