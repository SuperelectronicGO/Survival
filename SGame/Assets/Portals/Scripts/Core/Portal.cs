...
public class Portal : MonoBehaviour
{
    ...
    public string nameOfLinkedEnviroment;
    ...
    void HandleTravellers()
    {
        ...
        for (int i = 0; i < trackedTravellers.Count; i++)
        {
            ...
            if (portalSide != portalSideOld)
            {
                ...
                {
                    traveller.graphicsClone.transform.SetPositionAndRotation(new Vector3(positionOld.x, positionOld.y + 1.59f, positionOld.z), rotOld * traveller.rotationSetter.transform.localRotation);
                }
                else
                {
            ...
            else
            {
                if (traveller.isPlayer)
                {
                    traveller.graphicsClone.transform.SetPositionAndRotation(new Vector3(m.GetColumn(3).x, m.GetColumn(3).y + 1.59f, m.GetColumn(3).z), m.rotation * traveller.rotationSetter.transform.localRotation);
                }
                else
                {
